...
const PlantaCard = ({ planta }) => {
  return (
    <article className="planta-card-carrossel w-72 flex flex-col bg-white rounded-xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
      <div className="w-full h-40 overflow-hidden bg-stone-100 shrink-0">
        {planta.imagem ? (
          <img
            src={planta.imagem}
      ...
      <div className="p-4 flex flex-col flex-1 gap-2 text-center">
        <h3 className="text-base font-bold text-emerald-700 leading-snug">
          {planta.nomePopular}
        </h3>
        ...
        <p className="text-[0.7rem] text-stone-400 leading-relaxed pt-2 border-t border-stone-100 mt-auto">
          <strong className="text-stone-600">💡 Dica:</strong> {planta.dicasCuidado}
        </p>
      </div>
    </article>
  );
