          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                padding: '16px',
                border: 'none',
                background: abaAtiva === 'pendentes' ? '#eef5db' : '#fff',
                color: abaAtiva === 'pendentes' ? '#426b00' : '#546e7a',
                fontWeight: 700,
                fontSize: '0.95rem',
                cursor: 'pointer',
                borderBottom: abaAtiva === 'pendentes' ? '3px solid #426b00' : '3px solid transparent',
                fontFamily: 'inherit',
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                padding: '16px',
                border: 'none',
                background: abaAtiva === 'aprovados' ? '#eef5db' : '#fff',
                color: abaAtiva === 'aprovados' ? '#426b00' : '#546e7a',
                fontWeight: 700,
                fontSize: '0.95rem',
                cursor: 'pointer',
                borderBottom: abaAtiva === 'aprovados' ? '3px solid #426b00' : '3px solid transparent',
                fontFamily: 'inherit',
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                padding: '16px',
                border: 'none',
                background: abaAtiva === 'inscritos' ? '#eef5db' : '#fff',
                color: abaAtiva === 'inscritos' ? '#426b00' : '#546e7a',
                fontWeight: 700,
                fontSize: '0.95rem',
                cursor: 'pointer',
                borderBottom: abaAtiva === 'inscritos' ? '3px solid #426b00' : '3px solid transparent',
                fontFamily: 'inherit',
              }}
            >
                    ...
                    return (
                      ...
                      >
                        <div style={{
                          ...
                          height: '48px',
                          borderRadius: '50%',
                          background: 'linear-gradient(135deg, #426b00, #538700)',
                          display: 'flex',
                          alignItems: 'center',
                        ...
                        <div style={{ flex: 1, minWidth: '150px' }}>
                          <strong style={{ color: '#426b00', display: 'block' }}>{nome}</strong>
                  ...
                  {aprovados.map((inscricao) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div style={{ flex: 1 }}>
                          <strong style={{ color: '#426b00' }}>{nome}</strong>
                          <span style={{ display: 'block', fontSize: '0.82rem', color: '#426b00' }}>
