    ...
    return (
      <section className="eventos-section" style={{ paddingTop: '140px' }}>
        <div className="eventos-container" style={{ textAlign: 'center' }}>
          ...
          <Link to="/eventos" style={{ color: '#2e7d32', fontWeight: 600 }}>
            ← Voltar para Eventos
          </Link>
        </div>
      </section>
    ...
    <section className="eventos-section" style={{ paddingTop: '140px' }}>
      <div className="eventos-container" style={{ maxWidth: '900px' }}>
        ...
        <div style={{ marginBottom: '32px' }}>
          <Link
            to="/eventos"
            style={{ color: '#2e7d32', fontWeight: 600, fontSize: '0.9rem' }}
          >
            ← Voltar para Eventos
          </Link>
          <div
              ...
              <div>
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                    ...
                    />
                    {arquivo && (
                      <span style={{ fontSize: '0.8rem', color: '#2e7d32', fontWeight: 500 }}>
                        📎 {arquivo.name}
                      </span>
                    )}
                  </div>
