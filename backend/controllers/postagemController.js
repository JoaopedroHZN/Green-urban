// ============================================================
//  Controller de Postagens — Green Urban (Rede Social)
// ============================================================
...
// ------------------------------------------------------------
//  curtir — PATCH /api/postagens/:id/curtir
// ------------------------------------------------------------
...
// ------------------------------------------------------------
//  comentar — POST /api/postagens/:id/comentar
// ------------------------------------------------------------
...
module.exports = { listar, criar, curtir, comentar };